...
% ---
\titulo{Desenvolvimento de um Sistema Web para Avaliação de Classes da Universidade Federal de Ouro Preto}
\autor{Oto Braz Assunção}
...
% ---
    ...
    \section{Avaliações de Docentes}
        ...
        \begin{figure}[h]	
           ...
           \subcaption*{Fonte: \citeonline[p. 202]{fry:2009}}
        \end{figure}   
    ...
    \section{Frameworks}
        ...
        \textit{Frameworks} são estruturas genéricas reutilizáveis que implementam funcionalidades utilizadas por tipos similares de aplicações. Segundo \citeonline{schmidt:2004}, eles são um conjunto de artefatos integrados (classes, objetos e componentes) que fornecem uma arquitetura reusável à aplicações com domínios semelhantes.
   ...
   \subsection{MySql}
    ...
    \section{Sistemas Correlatos}
       ...
       Nesta seção serão apresentados alguns sistemas correlatos à plataforma desenvolvida. A correlação existem devido a um dos seguintes fatores: funcionalidades, métodos empregados e aplicação. 
        ...
        SisNTI\footnote{http://200.239.152.5/sisnti/} é o nome do sistema \textit{web} desenvolvido por \citeonline{plinio:2016} como trabalho de conclusão do curso de Sistemas de Informação da UFOP. O sistema tem como objetivo facilitar o gerenciamento das atividades que o Núcleo da Tecnologia da Informação (NTI) executa no ICEA. 
